export const QUESTIONS_LLM_IMPORT_PROMPT_PANEL_STYLES = {
  ...
  sectionPrompt: "mb-3 rounded-2xl border border-base-content/10 bg-base-200/25 p-3",
  sectionPromptLegend: "mb-2 block text-xs font-medium uppercase tracking-wide text-base-content/55",
  promptTextarea:
