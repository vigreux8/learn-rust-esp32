export const QUESTIONS_VIEW_STYLES = {
  ...
  filtersRow:
    "mb-4 flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-end sm:justify-between",
  filtersToolbar: "flex shrink-0 flex-col gap-2 sm:flex-row sm:items-center",
