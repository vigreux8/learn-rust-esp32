export const QUIZ_SESSION_STYLES = {
  ...
  categorieSeparator: "mt-3 border-t border-base-content/15 pt-3",
  categorieResume: "mb-2 text-xs font-medium text-base-content/70",
  ...
  categorieSubLabel: "mb-1.5 mt-2 text-[0.65rem] font-semibold uppercase tracking-wide text-base-content/45",
